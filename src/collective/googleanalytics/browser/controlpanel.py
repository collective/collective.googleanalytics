...
class AnalyticsControlPanelForm(ControlPanelForm):
    ...
    analytics_tracking['tracking_excluded_roles'].custom_widget = \
    ...
    form_fields = FormFieldsets(analytics_tracking,
    ...
    def _on_save(self, data={}):
        ...
        if tracking_web_property and snippet_analytics:
            ...
            plone_utils.addPortalMessage(
                ...
                feature of this product, but it looks like you still have \
                tracking code in the Site control panel. Please remove any \
                Google Analytics tracking code from the Site control panel to \
                avoid conflicts.'),
                'warning')
