...
class AnalyticsReport(PropertyManager, SimpleItem):
    """
    A Google Analytics report. The AnalyticsReport object defines all of
    the parameters used to query Google and format the result into a report.
    """
    ...
    _properties = (
        ...
        {'id': 'dimensions', 'type': 'multiple selection', 'mode': 'w',
            ...
            'select_variable': 'getDimensionsChoices'},
        ...
        {'id': 'viz_type', 'type': 'selection', 'mode': 'w',
            ...
            'select_variable': 'getVisualizationChoices'},
