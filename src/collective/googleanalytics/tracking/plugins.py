...
class AnalyticsMediaElementJsPlugin(AnalyticsBaseTrackingPlugin):
    """
    A tracking plugin to track HTML5 video playback from MediaElement.js.
    """

    __call__ = ViewPageTemplateFile('mediaelementjs.pt')
